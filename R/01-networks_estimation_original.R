...
saveRDS(epistats, paste0(est_dir, "template_epistats-", context, ".rds"))
...
saveRDS(netstats, paste0(est_dir, "template_netstats-", context, ".rds"))
...
saveRDS(out, paste0(est_dir, "template_netest-", context, ".rds"))
